...
const t = {
    en: {
        ...
        about_p1:      "Hey, I'm Your Name — a full-stack developer based in [Your City], passionate about building elegant, high-performance web applications.",
        about_p2:      "With X years of hands-on experience I turn complex ideas into clean, maintainable code. I care as much about developer ergonomics as user experience.",
        about_p3:      "When I'm not shipping code you'll find me exploring new frameworks, contributing to open source, or perfecting my morning coffee ritual.",
        ...
        s2_title: 'Backend & APIs',
        s2_desc:  'Scalable server-side solutions, RESTful and GraphQL APIs, and database architecture. Built to last.',
        s3_title: 'Full-Stack Apps',
        s3_desc:  'End-to-end from brief to deployment. Auth, payments, real-time features — handled with care and craft.',
    ...
    ro: {
        ...
        about_p1:      'Bună, sunt Numele Tău — un developer full-stack din [Orașul Tău], pasionat de construirea de aplicații web elegante și performante.',
        about_p2:      'Cu X ani de experiență practică, transform idei complexe în cod curat și ușor de întreținut. Îmi pasă la fel de mult de ergonomia dezvoltatorului cât și de experiența utilizatorului.',
        about_p3:      'Când nu scriu cod, mă găsești explorând framework-uri noi, contribuind la open source sau perfecționând ritualul cafelei de dimineață.',
        ...
        s2_title: 'Backend & API-uri',
        s2_desc:  'Soluții server-side scalabile, API-uri RESTful și GraphQL, arhitectură de baze de date. Construite să dureze.',
        s3_title: 'Aplicații Full-Stack',
        s3_desc:  'De la brief până la deployment. Autentificare, plăți, funcționalități în timp real — gestionate cu grijă și măiestrie.',
